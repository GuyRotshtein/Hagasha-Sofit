                        ...
                        <div class="container main-container">
                            ...
                            <div class="row 3 py-3">
                                ...
                                <div class="col text-center">
                                    <label class="form-label mobile-label">First name</label>
                            ...
                            <div class="row 3 py-3">
                                ...
                                <div class="col text-center">
                                    <label class="form-label mobile-label">Last name</label>
                            ...
                            <div class="row 3 py-3">
                                ...
                                <div class="col text-center">
                                    <label class="form-label mobile-label">E-mail address</label>
                            ...
                            <div class="row py-3">
                                ...
                                <div class="col text-center">
                                    <label class="form-label mobile-label">Password</label>
                            ...
                            <div class="row 3 py-3">
                                ...
                                <div class="col text-center">
                                    <label class="form-label mobile-label">Phone number</label>
                            ...
                            <div class="row 3 py-3">
                                ...
                                <div class="col text-center">
                                    <label class="form-label mobile-label">Country</label>
                            ...
                            <div class="row 3 py-3">
                                ...
                                <div class="col text-center">
                                    <label class="form-label mobile-label">Gender</label>
